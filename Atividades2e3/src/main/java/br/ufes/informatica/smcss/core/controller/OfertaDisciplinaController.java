...
public class OfertaDisciplinaController extends CrudController<OfertaDisciplina> {
	 ...
	 *
	 * @param event Evento de seleção do autocompletar, com atributo object
	 *              contendo o valor selecionado.
	 */
	...
	/**
	 * Sobrescrevendo métodos da classe base para implementar filtragem por
	 * período, em função da falta de tempo hábil para estudar melhor o sistema
	 * de filtragem do JButler
	 */
	...
	protected void retrieveEntities() {
		...
		entities = ofertaDisciplinaService.listOfertasByPeriodoLetivo(periodoLetivo, firstEntityIndex, lastEntityIndex);

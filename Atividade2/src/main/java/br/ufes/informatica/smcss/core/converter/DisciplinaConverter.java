...
public abstract class DisciplinaConverter implements Converter<Disciplina> {
    ...
    public String getAsString(FacesContext context, UIComponent component, Disciplina value) {
        return (value == null) ? null : convertToString.apply(value);
    }
    ...
    public static class DisciplinaCodigoConverter extends DisciplinaConverter {
        public DisciplinaCodigoConverter() {
            super(Disciplina::getCodigo, DisciplinaDAO::findByCodigo);
        }
    }
